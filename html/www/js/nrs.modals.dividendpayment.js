...
var NRS = (function(NRS, $, undefined) {
    ...
    $("#dividend_payment_amount_per_share, #dividend_payment_height").on("blur", function() {
        ...
        var amountNGPPerShare = $modal.find("#dividend_payment_amount_per_share").val();
        ...
        if (amountNGPPerShare && /^\d+$/.test(height)) {
            NRS.getAssetAccounts(NRS.getCurrentAsset().asset, height,
                function (response) {
                    ...
                    var priceNQT = new BigInteger(NRS.calculatePricePerWholeQNT(NRS.convertToNQT(amountNGPPerShare), NRS.getCurrentAsset().decimals));
                    var totalNGP = NRS.calculateOrderTotal(totalQuantityQNT, priceNQT);
