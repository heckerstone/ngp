const options = {
    url: "http://localhost:6876", // URL of NGP remote node
...
exports.load = function(callback) {
    ...
    require("jsdom").env("", function(err, window) {
        try {
            ...
            // the NGP client was note designed with modularity in mind there we have
            ...
            // Now load some NGP specific libraries into the global scope
            global.NgpAddress = require('./util/ngpaddress');
            ...
            // however the NGP client relies on a global browser scope which defines the NRS object
