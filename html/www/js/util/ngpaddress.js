...
/*
    NGP address class, extended version (with error guessing).

    Version: 1.0, license: Public Domain, coder: NgpChg (admin@ngpchg.com).
*/
...
function NgpAddress() {
	...
	this.set = function(adr, allow_accounts) {
		...
		if (adr.indexOf('NGP-') == 0) adr = adr.substr(4);
