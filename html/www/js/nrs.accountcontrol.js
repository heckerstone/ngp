...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			labelText: "Amount NGP",
			labelI18n: "amount_ngp",
			helpI18n: "approve_transaction_amount_help",
			inputName: "controlQuorumNGP",
			addonText: "NGP",
			addonI18n: "ngp_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_ngp', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceNGP';
		context['addonText'] = 'NGP';
		context['addonI18n'] = 'ngp_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_ngp', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
