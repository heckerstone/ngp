...
public class DesktopApplication extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        webEngine.setUserDataDirectory(NGP.getConfDir());
        ...
        loadWorker.stateProperty().addListener(
                (ov, oldState, newState) -> {
                    ...
                    stage.setTitle("NGP Desktop - " + webEngine.getLocation());
                    ...
                    NGP.getTransactionProcessor().addListener((transaction) ->
        ...
        stage.getIcons().add(new Image(address + "/img/ngp-icon-32x32.png"));
    ...
    private static String getUrl() {
        ...
        String defaultAccount = NGP.getStringProperty("ngp.defaultDesktopAccount");
