...
public abstract class NgpException extends Exception {

    protected NgpException() {
        super();
    }

    protected NgpException(String message) {
        super(message);
    }

    protected NgpException(String message, Throwable cause) {
        super(message, cause);
    }

    protected NgpException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends NgpException {
    ...
    public static final class NgpIOException extends IOException {

        public NgpIOException(String message) {
            super(message);
        }

        public NgpIOException(String message, Throwable cause) {
            super(message, cause);
        }
