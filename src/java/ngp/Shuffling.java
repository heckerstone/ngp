...
import ngp.crypto.AnonymouslyEncryptedData;
...
public final class Shuffling {
    ...
    private static final boolean deleteFinished = NGP.getBooleanProperty("ngp.deleteFinishedShufflings");
    ...
    private void cancel(Block block) {
        ...
        if (blamedAccountId != 0) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                Logger.logDebugMessage("Shuffling penalty %f NGP awarded to forger at height %d", ((double)fee) / Constants.ONE_NGP, block.getHeight() - i - 1);
            }
            ...
            Logger.logDebugMessage("Shuffling penalty %f NGP awarded to forger at height %d", ((double)fee) / Constants.ONE_NGP, block.getHeight());
        }
