...
import static ngp.user.JSONResponses.DENY_ACCESS;
import static ngp.user.JSONResponses.INCORRECT_REQUEST;
import static ngp.user.JSONResponses.POST_REQUIRED;
...
public final class UserServlet extends HttpServlet  {
    ...
    abstract static class UserRequestHandler {
        abstract JSONStreamAware processRequest(HttpServletRequest request, User user) throws NgpException, IOException;
        boolean requirePost() {
            return false;
        }
    }

    private static final boolean enforcePost = NGP.getBooleanProperty("ngp.uiServerEnforcePOST");
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } catch (RuntimeException|NgpException e) {
