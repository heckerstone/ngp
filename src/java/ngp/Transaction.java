...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws NgpException.NotValidException;

        Transaction build(String secretPhrase) throws NgpException.NotValidException;
    ...
    void validate() throws NgpException.ValidationException;
