...
public final class Constants {
    ...
    public static final boolean isTestnet = NGP.getBooleanProperty("ngp.isTestnet");
    public static final boolean isOffline = NGP.getBooleanProperty("ngp.isOffline");
    public static final boolean isLightClient = NGP.getBooleanProperty("ngp.isLightClient");

    public static final int MAX_NUMBER_OF_TRANSACTIONS = 512;
    public static final int MIN_TRANSACTION_SIZE = 176;
    public static final int MAX_PAYLOAD_LENGTH = MAX_NUMBER_OF_TRANSACTIONS * MIN_TRANSACTION_SIZE;
    public static final long MAX_BALANCE_NGP = 10000000000L;
//    public static final long MAX_BALANCE_NGP = 1000000000;
    public static final long ONE_NGP = 100000000;
    public static final long MAX_BALANCE_NQT = MAX_BALANCE_NGP * ONE_NGP;
    public static final long INITIAL_BASE_TARGET = 153722867;
    public static final long MAX_BASE_TARGET = MAX_BALANCE_NGP * INITIAL_BASE_TARGET;
    ...
    public static final int MAX_ROLLBACK = Math.max(NGP.getIntProperty("ngp.maxRollback"), 720);
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? NGP.getIntProperty("ngp.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int LEASING_DELAY = isTestnet ? NGP.getIntProperty("ngp.testnetLeasingDelay", 1440) : 1440;
    public static final long MIN_FORGING_BALANCE_NQT = 1000 * ONE_NGP;

    public static final int MAX_TIMEDRIFT = 15; // allow up to 15 s clock difference
    public static final int FORGING_DELAY = NGP.getIntProperty("ngp.forgingDelay");
    public static final int FORGING_SPEEDUP = NGP.getIntProperty("ngp.forgingSpeedup");
    ...
    static {
        int maxPrunableLifetime = NGP.getIntProperty("ngp.maxPrunableLifetime");
        ENABLE_PRUNING = maxPrunableLifetime >= 0;
        MAX_PRUNABLE_LIFETIME = ENABLE_PRUNING ? Math.max(maxPrunableLifetime, MIN_PRUNABLE_LIFETIME) : Integer.MAX_VALUE;
    }
    public static final boolean INCLUDE_EXPIRED_PRUNABLE = NGP.getBooleanProperty("ngp.includeExpiredPrunable");
    ...
    public static final long MAX_CURRENCY_TOTAL_SUPPLY = 10000000000L * 100000000L;
...
//    public static final int CHECKSUM_BLOCK_21 = isTestnet ? 1051000 : 0;
    ...
    static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (isTestnet ? 50 : 100) * ONE_NGP;
    public static final long SHUFFLING_DEPOSIT_NQT = (isTestnet ? 7 : 1000) * ONE_NGP;

    public static final boolean correctInvalidFees = NGP.getBooleanProperty("ngp.correctInvalidFees");
