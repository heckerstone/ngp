...
/**
 * Java LogManager extension for use with NGP
 */
public class NgpLogManager extends LogManager {

    /** Logging reconfiguration in progress */
    private volatile boolean loggingReconfiguration = false;

    /**
     * Create the NGP log manager
     *
     ...
     * done terminating the NGP processes.
     */
    public NgpLogManager() {
        super();
    }
     ...
     * This allows us to continue to use logging facilities during NGP shutdown.
     */
    @Override
    public void reset() {
    ...
    /**
     * NGP shutdown is now complete, so call LogManager.reset() to terminate
     * the log handlers.
     */
    void ngpShutdown() {
        super.reset();
