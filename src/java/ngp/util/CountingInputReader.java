...
import ngp.NgpException.NgpIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  NgpIOException      Maximum count exceeded
     */
    private void incCount(long c) throws NgpIOException {
        count += c;
        if (count > limit)
            throw new NgpIOException("Maximum size exceeded: " + count);
    }
}
