...
public class UPnP {
    ...
    private static void init() {
        ...
        try {
            ...
            GatewayDevice.setHttpReadTimeout(NGP.getIntProperty("ngp.upnpGatewayTimeout", GatewayDevice.getHttpReadTimeout()));
            GatewayDiscover discover = new GatewayDiscover();
            discover.setTimeout(NGP.getIntProperty("ngp.upnpDiscoverTimeout", discover.getTimeout()));
