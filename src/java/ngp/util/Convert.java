...
public final class Convert {
    ...
    public static String rsAccount(long accountId) {
        return "NGP-" + Crypto.rsEncode(accountId);
    }
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws NgpException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new NgpException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseNGP(String ngp) {
        return parseStringFraction(ngp, 8, Constants.MAX_BALANCE_NGP);
    }
