...
public final class AddOns {
    ...
    static {
        ...
        NGP.getStringListProperty("ngp.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !NGP.getBooleanProperty("ngp.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", NGP.isDesktopApplicationEnabled() ? "ngpdesktop.policy" : "ngp.policy");
