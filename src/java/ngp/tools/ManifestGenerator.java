...
import ngp.NGP;
import ngp.env.service.NgpService_ServiceManagement;

public class ManifestGenerator {

    public static void main(String[] args) {
        ManifestGenerator manifestGenerator = new ManifestGenerator();
        manifestGenerator.generate("./resource/ngp.manifest.mf", NGP.class.getCanonicalName(), "./lib");
        String serviceClassName = NgpService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/ngpservice.manifest.mf", serviceClassName, "./lib");
    }
