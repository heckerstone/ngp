...
/**
 * Issue a currency on the NGP blockchain
 * <p>
 * A currency is the basic block of the NGP Monetary System it can be exchanged with NGP, transferred between accounts,
 ...
 * For {@link ngp.CurrencyType#RESERVABLE} currency
 * <li>minReservePerUnitNQT - the minimum NGP value per unit to allow the currency to become active
 * For {@link ngp.CurrencyType#RESERVABLE} currency
 ...
 * For {@link ngp.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link ngp.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link ngp.crypto.HashFunction algorithm} used for minting.
 * For {@link ngp.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link ngp.CurrencyType#EXCHANGEABLE} nor {@link ngp.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link ngp.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link ngp.CurrencyType#RESERVABLE} becomes active, in case it is {@link ngp.CurrencyType#CLAIMABLE} the NGP used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link ngp.CurrencyType#RESERVABLE} becomes active, in case it is non {@link ngp.CurrencyType#CLAIMABLE} the NGP used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link ngp.CurrencyType#MINTABLE} currency, the number of units per {@link ngp.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link ngp.http.CurrencyMint}<br>
 * </ul>
 *
 * @see ngp.CurrencyType
 * @see ngp.crypto.HashFunction
 */
