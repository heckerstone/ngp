...
import ngp.http.EventListener.PendingEvent;
 ...
 * ngp.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than ngp.apiEventTimeout.</li>
 * </ul>
 *
