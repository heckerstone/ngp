...
import static ngp.http.JSONResponses.MONITOR_ALREADY_STARTED;
import static ngp.http.JSONResponses.UNKNOWN_ACCOUNT;
import static ngp.http.JSONResponses.incorrect;
 ...
 * <p>
 * A funding monitor will transfer NGP, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * NGP amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws  NgpException        Unable to process request
     */
    @Override
