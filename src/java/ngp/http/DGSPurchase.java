...
import static ngp.http.JSONResponses.INCORRECT_DELIVERY_DEADLINE_TIMESTAMP;
import static ngp.http.JSONResponses.INCORRECT_PURCHASE_PRICE;
import static ngp.http.JSONResponses.INCORRECT_PURCHASE_QUANTITY;
import static ngp.http.JSONResponses.MISSING_DELIVERY_DEADLINE_TIMESTAMP;
import static ngp.http.JSONResponses.UNKNOWN_GOODS;
...
public final class DGSPurchase extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws NgpException {
        ...
        try {
            ...
            if (deliveryDeadline <= NGP.getEpochTime()) {
