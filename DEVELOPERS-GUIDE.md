...
### Usable URLs ###
  ...
  - **API** - http://localhost:7877/test
  - **DB Interface** - http://localhost:7877/dbshell
  - **Java Class Browser** - http://localhost:7877/doc

### Database ###
  
  - H2 embedded database
  - main database: `ngp_db/`
  - test database: `ngp_test_db/`
  ...
  - use the ngp.db framework when accessing the database from your code
...
### Testing ###
  ...
  - all API calls can be tested manually from the auto-generated http://localhost:7877/test page
...
- https://crowdin.com/project/ngp-ui-translation
...
The NGP wallet UI run as a mobile app.
...
6. Under the <NGPRoot>\mobile\app folder execute the command:
createapp.bat
